...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:variable name="DH_VIEW_CDA_STYLESHEET_VERSION">1.1.0-alpha1</xsl:variable>
                                    ...
                                    <table class="GroupEntriesTable" width="100%">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="{$headerCssStyle} GroupEntriesModality">Location</th>
