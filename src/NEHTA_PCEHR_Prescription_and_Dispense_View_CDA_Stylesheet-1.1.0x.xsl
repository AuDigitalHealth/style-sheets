...
<xsl:stylesheet version="1.0" 
    ...
    <xsl:variable name="NEHTA_PCEHR_PRESCRIPTION_AND_DISPENSE_VIEW_CDA_STYLESHEET_VERSION">1.1.0</xsl:variable>
    
    <!-- Version note -->
    <xsl:variable name="VERSION_NOTE">HTML Generated by the NEHTA PCEHR Prescription And Dispense View CDA Stylesheet Version: <xsl:value-of select="$NEHTA_PCEHR_PRESCRIPTION_AND_DISPENSE_VIEW_CDA_STYLESHEET_VERSION"/> </xsl:variable>
    ...
    <!-- PCEHR Prescription and Dispense View From/To Dates -->
    ...
    <!-- PCEHR Prescription and Dispense Grouping -->
    ...
    <xsl:template match="/cda:ClinicalDocument">
        <xsl:element name="html"> 
            ...
            <xsl:element name="head">
                ...
                <link rel="stylesheet" type="text/css" href="NEHTA_PCEHR_Prescription_and_Dispense_View_CDA_Stylesheet-1.0.1x.css"/>
            </xsl:element> <!-- </head> -->
