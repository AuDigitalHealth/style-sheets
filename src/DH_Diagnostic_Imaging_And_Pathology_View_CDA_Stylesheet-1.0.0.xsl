...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <!-- Group by parameters. Options are 'organisation', 'requester' and 'reportId' -->
    ...
    <xsl:key name="diRequesterKey" match="di:diagnosticImagingReport"
        use="concat(di:imagingRequesterInformation/vct:providerName/vct:nameTitle, ' ',        
        di:imagingRequesterInformation/vct:providerName/vct:givenName, ' ',
        di:imagingRequesterInformation/vct:providerName/vct:familyName)"/>
    ...
    <xsl:key name="pathRequesterKey" match="path:pathologyReport"
        use="concat(path:testRequesterInformation/vct:providerName/vct:nameTitle, ' ',        
        path:testRequesterInformation/vct:providerName/vct:givenName, ' ',
        path:testRequesterInformation/vct:providerName/vct:familyName)"/>
    <!--================================================================================================================================================================================-->
    <!-- END KEYS -->
    ...
    <xsl:variable name="DH_VIEW_CDA_STYLESHEET_VERSION">1.0.0-alpha1</xsl:variable>
    ...
    <xsl:variable name="cdaDocumentTitle">
        <xsl:choose>
            <xsl:when test="$DI_VIEW"> Diagnostic Imaging View </xsl:when>
            <xsl:when test="$PATH_VIEW"> Pathology View </xsl:when>            
    ...
    <xsl:template name="processDiStructuredBody">   
        ...
        <xsl:if test="$hiddenCount > 0">
            <div class="HeadingsTableGenericNameHeading" style="margin-top: 10px; margin-left: 10px; margin-right: 10px;">
                Warning: <xsl:value-of select="$hiddenCount" /> record(s) hidden due to the filter. Remove the filter to see the full list.
            </div>
        </xsl:if>
        ...
        <xsl:choose>
            ...
            <xsl:when test="$groupBy = 'reportId'">
                <xsl:call-template name="processDiGroups">
                    <xsl:with-param name="groups" select="/di:diagnosticImagingReportViewResponse/di:diagnosticImagingReport
                        [generate-id(.)=generate-id(key('diReportIdKey',di:reportInformation/vct:accessionNumber)[1])]">                
                    </xsl:with-param>
                </xsl:call-template>
            </xsl:when>    
            ...
            <xsl:when test="$groupBy = 'requester'">
                <xsl:call-template name="processDiGroups">
                    <xsl:with-param name="groups" select="/di:diagnosticImagingReportViewResponse/di:diagnosticImagingReport
                        [generate-id(.)=generate-id(key('diRequesterKey',
                        concat(di:imagingRequesterInformation/vct:providerName/vct:nameTitle, ' ',        
                        di:imagingRequesterInformation/vct:providerName/vct:givenName, ' ',
                        di:imagingRequesterInformation/vct:providerName/vct:familyName)
                        )[1])]">                
                    </xsl:with-param>
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <xsl:if test="$groupBy != 'organisation'">
                                                    <th class="{$headerCssStyle} GroupEntriesOrganisation">Diagnostic Imaging Organisation</th>
                                                </xsl:if>
                                                <xsl:if test="$groupBy != 'requester'">
                                                    <th class="{$headerCssStyle} GroupEntriesRequester">Requesting Professional</th>
                                                </xsl:if>
                                                <th class="{$headerCssStyle} GroupEntriesStatus">Report Status</th>
    ...
    <xsl:template name="processDiGroups">
        ...
        <xsl:choose>
            ...
            <xsl:when test="$groupBy = 'reportId'">
                <xsl:for-each select="$groups">
                    <xsl:sort select="di:reportInformation/vct:accessionNumber"/>
                    
                    <xsl:variable name="reportId" select="di:reportInformation/vct:accessionNumber" />                    
                    <xsl:variable name="filteredEntries" select="key('diReportIdKey', $reportId)/di:imagingExaminationResult
                        [contains(translate(di:examinationResultName/vct:displayName, $upperCaseCharacters, $lowerCaseCharacters), $resultNameFilterLowercase) or
                        contains(translate(di:examinationResultName/vct:originalText, $upperCaseCharacters, $lowerCaseCharacters), $resultNameFilterLowercase)]"/>
                                                            
                    <xsl:call-template name="processDiTable">
                        <xsl:with-param name="groupName" select="$reportId" />
                        <xsl:with-param name="entries" select="$filteredEntries" />
                    </xsl:call-template>
                </xsl:for-each>      
            </xsl:when>
            <xsl:when test="$groupBy = 'requester'">
                <xsl:for-each select="$groups">
                    <xsl:sort select="concat(di:imagingRequesterInformation/vct:providerName/vct:nameTitle, ' ',        
                        di:imagingRequesterInformation/vct:providerName/vct:givenName, ' ',
                        di:imagingRequesterInformation/vct:providerName/vct:familyName)"/>
                    
                    <xsl:variable name="requester" select="concat(di:imagingRequesterInformation/vct:providerName/vct:nameTitle, ' ',        
                            di:imagingRequesterInformation/vct:providerName/vct:givenName, ' ',
                            di:imagingRequesterInformation/vct:providerName/vct:familyName)" />                   
                    <xsl:variable name="filteredEntries" select="key('diRequesterKey', $requester)/di:imagingExaminationResult
                        [contains(translate(di:examinationResultName/vct:displayName, $upperCaseCharacters, $lowerCaseCharacters), $resultNameFilterLowercase)or
                        contains(translate(di:examinationResultName/vct:originalText, $upperCaseCharacters, $lowerCaseCharacters), $resultNameFilterLowercase)]"/>
                    
                    <xsl:call-template name="processDiTable">
                        <xsl:with-param name="groupName" select="$requester" />
                        <xsl:with-param name="entries" select="$filteredEntries" />
                    </xsl:call-template>
                </xsl:for-each>    
        ...
        <xsl:if test="$groupBy = 'reportId' and 
            count(//di:diagnosticImagingReport/di:reportInformation[not(vct:accessionNumber)]) > 0">
            <xsl:call-template name="getGroupSpacer"/>
                        
            <xsl:call-template name="processDiTable">
                <xsl:with-param name="groupName" select="'Unmatched'" />
                <xsl:with-param name="entries" select="//di:diagnosticImagingReport[not(di:reportInformation/vct:accessionNumber)]/di:imagingExaminationResult
                    [contains(translate(di:examinationResultName/vct:displayName, $upperCaseCharacters, $lowerCaseCharacters), $resultNameFilterLowercase)or
                    contains(translate(di:examinationResultName/vct:originalText, $upperCaseCharacters, $lowerCaseCharacters), $resultNameFilterLowercase)]"/>
            </xsl:call-template>
        </xsl:if>        
    ...
    <xsl:template name="processPathGroups">
        ...
        <xsl:choose>
            ...
            <xsl:when test="$groupBy = 'reportId'">
                <xsl:for-each select="$groups">
                    <xsl:sort select="path:reportInformation/vct:pathologistLocalReportId"/>
                    
                    <xsl:variable name="reportId" select="path:reportInformation/vct:pathologistLocalReportId" />
                    <xsl:variable name="filteredEntries" select="key('pathReportIdKey', $reportId)/path:pathologyTestResult
                        [contains(translate(path:testResultName/vct:displayName, $upperCaseCharacters, $lowerCaseCharacters), $resultNameFilterLowercase) or
                        contains(translate(path:testResultName/vct:originalText, $upperCaseCharacters, $lowerCaseCharacters), $resultNameFilterLowercase)]"/>
            ...
            <xsl:when test="$groupBy = 'requester'">
                <xsl:for-each select="$groups">
                    <xsl:sort select="concat(path:testRequesterInformation/vct:providerName/vct:nameTitle, ' ',        
                        path:testRequesterInformation/vct:providerName/vct:givenName, ' ',
                        path:testRequesterInformation/vct:providerName/vct:familyName)"/>
                    
                    <xsl:variable name="requester" select="concat(path:testRequesterInformation/vct:providerName/vct:nameTitle, ' ',        
                            path:testRequesterInformation/vct:providerName/vct:givenName, ' ',
                            path:testRequesterInformation/vct:providerName/vct:familyName)" />
                    <xsl:variable name="filteredEntries" select="key('pathRequesterKey', $requester)/path:pathologyTestResult
                        [contains(translate(path:testResultName/vct:displayName, $upperCaseCharacters, $lowerCaseCharacters), $resultNameFilterLowercase) or
                        contains(translate(path:testResultName/vct:originalText, $upperCaseCharacters, $lowerCaseCharacters), $resultNameFilterLowercase)]"/>
        ...
        <xsl:if test="$groupBy = 'reportId' and 
            count(//path:pathologyReport/path:reportInformation[not(vct:pathologistLocalReportId)]) > 0">
            <xsl:call-template name="getGroupSpacer"/>                       
            
            <xsl:call-template name="processPathTable">
                <xsl:with-param name="groupName" select="'Unmatched'" />
                <xsl:with-param name="entries" select="//path:pathologyReport[not(path:reportInformation/vct:pathologistLocalReportId)]/path:pathologyTestResult
                    [contains(translate(path:testResultName/vct:displayName, $upperCaseCharacters, $lowerCaseCharacters), $resultNameFilterLowercase) or
                    contains(translate(path:testResultName/vct:originalText, $upperCaseCharacters, $lowerCaseCharacters), $resultNameFilterLowercase)]"/>
            </xsl:call-template>
        </xsl:if>        
    ...
    <xsl:template name="processDiTableEntries">
        ...
        <xsl:for-each select="$entries">
            <xsl:sort select="di:imagingServiceDateTime"/>
            ...
            <xsl:variable name="requestingProfessional">
                <xsl:call-template name="formatName">
                    <xsl:with-param name="name" select="../di:imagingRequesterInformation/vct:providerName"/>
                </xsl:call-template>
            </xsl:variable>
            
            <xsl:variable name="reportStatus">
                <xsl:call-template name="codeDescription">
                    <xsl:with-param name="code" select="../di:reportInformation/vct:reportStatus"/>
                </xsl:call-template>
            </xsl:variable>
            ...
            <xsl:element name="tr">
                ...
                <xsl:if test="$groupBy != 'requester'">
                    <xsl:element name="td">
                        <xsl:attribute name="class">GroupEntriesTableCell</xsl:attribute>
                        <xsl:value-of select="$requestingProfessional"/>
                    </xsl:element>
                </xsl:if>
                <xsl:element name="td">
                    <xsl:attribute name="class">GroupEntriesTableCell</xsl:attribute>
                    <!-- Which $reportStatus should we use? -->
                    <xsl:call-template name="codeDescription">
                        <xsl:with-param name="code" select="di:overallTestResultStatus"/>
                    </xsl:call-template>
                </xsl:element>
                <xsl:element name="td">
                    <xsl:attribute name="class">GroupEntriesTableCell</xsl:attribute>
    ...
    <xsl:template name="processPathTableEntries">
        ...
        <xsl:for-each select="$entries">
            <xsl:sort select="path:specimenCollectionDate"/>
            ...
            <xsl:variable name="requestingProfessional">
                <xsl:call-template name="formatName">
                    <xsl:with-param name="name" select="../path:testRequesterInformation/vct:providerName"/>
                </xsl:call-template>
            </xsl:variable>
            
            <xsl:variable name="reportStatus">
                <xsl:call-template name="codeDescription">
                    <xsl:with-param name="code" select="../path:reportInformation/vct:reportStatus"/>
                </xsl:call-template>
            </xsl:variable>
            ...
            <xsl:element name="tr">
                ...
                <xsl:element name="td">
                    ...
                    <!-- Which $reportStatus should we use? -->
                    <xsl:call-template name="codeDescription">
                        <xsl:with-param name="code" select="path:overallTestResultStatus"/>
                    </xsl:call-template>
                </xsl:element>
                <xsl:if test="$groupBy != 'reportId'">
                    <xsl:element name="td">
    ...
    <xsl:template name="processPathStructuredBody">    
        ...
        <xsl:choose>
            ...
            <xsl:when test="$groupBy = 'reportId'">
                <xsl:call-template name="processPathGroups">
                    <xsl:with-param name="groups" select="/path:pathologyReportViewResponse/path:pathologyReport
                        [generate-id(.)=generate-id(key('pathReportIdKey',path:reportInformation/vct:pathologistLocalReportId)[1])]">                
                    </xsl:with-param>
                </xsl:call-template>
            </xsl:when>    
            ...
            <xsl:when test="$groupBy = 'requester'">
                <xsl:call-template name="processPathGroups">
                    <xsl:with-param name="groups" select="/path:pathologyReportViewResponse/path:pathologyReport
                        [generate-id(.)=generate-id(key('pathRequesterKey',
                        concat(path:testRequesterInformation/vct:providerName/vct:nameTitle, ' ',        
                        path:testRequesterInformation/vct:providerName/vct:givenName, ' ',
                        path:testRequesterInformation/vct:providerName/vct:familyName)
                        )[1])]">                
                    </xsl:with-param>
                                    ...
                                    <table class="GroupEntriesTable" width="100%">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="{$headerCssStyle} GroupEntriesModality">Test Name</th>
                                                <th class="{$headerCssStyle} GroupEntriesExamination">Status</th>
                                                <xsl:if test="$groupBy != 'reportId'">
