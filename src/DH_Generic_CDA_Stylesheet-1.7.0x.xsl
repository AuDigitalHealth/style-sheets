...
<xsl:stylesheet version="1.0" 
    ...
    <xsl:variable name="DH_GENERIC_CDA_STYLESHEET_VERSION">1.7.0 - alpha2</xsl:variable>
    ...
    <xsl:template match="/cda:ClinicalDocument">
        <xsl:element name="html"> 
            ...
            <xsl:element name="head">
                ...
                <link rel="stylesheet" type="text/css" href="DH_Generic_CDA_Stylesheet-1.7.0x.css"/>
            </xsl:element> <!-- </head> -->
