...
<xsl:stylesheet version="1.0" 
    ...
    <xsl:variable name="DH_MHR_PRESCRIPTION_AND_DISPENSE_VIEW_CDA_STYLESHEET_VERSION">1.1.2</xsl:variable>
    ...
    <xsl:template match="/cda:ClinicalDocument">
        <xsl:element name="html"> 
            ...
            <xsl:element name="head">
                ...
                <link rel="stylesheet" type="text/css" href="NEHTA_PCEHR_Prescription_and_Dispense_View_CDA_Stylesheet-1.1.1x.css"/>
            </xsl:element> <!-- </head> -->
